...
import { exportManualPDFRepresentante } from "../../utils/exportManualPdfRepresentante";
import {
  LayoutDashboard,
  Users,
  Activity,
      ...
      >
        ...
        <div className="h-[88px] flex items-center gap-3 px-5 border-b border-white/8">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[9px] font-medium text-blue-300/70 tracking-[0.2em] uppercase">
              TEA Monitor
            </span>
          </div>
        </div>
            ...
            return (
              <button
                ...
                onClick={() => {
                  ...
                  if (item.id === "manual_repre") {
                    showToast("📖 Generando manual de usuario en PDF...");
                    exportManualPDFRepresentante();
                    setIsSidebarOpen(false);
                    return;
                  }
                  navigate(item.id);
