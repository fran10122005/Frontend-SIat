            ...
            {loading ? (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                  <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 flex flex-col items-center animate-pulse">
                    <div className="w-24 h-24 rounded-full bg-slate-200 dark:bg-slate-700 mb-4 animate-pulse"></div>
                  ...
                  <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 space-y-4 animate-pulse">
                    <div className="h-4 w-28 bg-slate-200 dark:bg-slate-700 rounded-md mb-2"></div>
                ...
                <div className="lg:col-span-2 space-y-8 animate-pulse">
                  <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 space-y-6">
                    <div className="h-5 w-36 bg-slate-200 dark:bg-slate-700 rounded-md"></div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2"><div className="h-3 w-16 bg-slate-200 dark:bg-slate-700 rounded-md"></div><div className="h-10 bg-slate-200 dark:bg-slate-700 rounded-xl"></div></div>
                      <div className="space-y-2"><div className="h-3 w-16 bg-slate-200 dark:bg-slate-700 rounded-md"></div><div className="h-10 bg-slate-200 dark:bg-slate-700 rounded-xl"></div></div>
                      <div className="space-y-2"><div className="h-3 w-16 bg-slate-200 dark:bg-slate-700 rounded-md"></div><div className="h-10 bg-slate-200 dark:bg-slate-700 rounded-xl"></div></div>
                      <div className="space-y-2"><div className="h-3 w-16 bg-slate-200 dark:bg-slate-700 rounded-md"></div><div className="h-10 bg-slate-200 dark:bg-slate-700 rounded-xl"></div></div>
                    </div>
                    <div className="flex justify-end"><div className="h-10 w-36 bg-slate-200 dark:bg-slate-700 rounded-xl"></div></div>
                  </div>
                </div>
              </div>
            ) : (
