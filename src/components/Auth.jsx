...
export default function Auth({ currentView, onNavigate }) {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#F4F7F9] dark:bg-slate-900 overflow-hidden font-sans">
      ...
      {/* Forms Container */}
      <div 
        className={`absolute top-0 w-full md:w-1/2 h-full transition-transform duration-700 ease-in-out z-10 bg-white dark:bg-slate-900 shadow-2xl
      ...
      {/* Presentation Image / Branding Container */}
      <div 
        className={`hidden md:flex absolute top-0 w-1/2 h-full bg-[#003366] dark:bg-slate-950 text-white flex-col items-center justify-center p-8 lg:p-16 transition-transform duration-700 ease-in-out z-20
