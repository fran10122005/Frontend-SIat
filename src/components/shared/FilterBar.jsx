...
export default function FilterBar({
  ...
  return (
    ...
    >
      <div className="flex flex-row flex-wrap items-center gap-2.5">
        {searchValue !== undefined && (
          <div className="relative flex-1 min-w-[240px]">
            ...
            <input
              ...
              className="w-full pl-4 pr-10 py-2 h-10 text-sm text-ellipsis bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
            />
          </div>
        )}
        ...
        {hasAdvanced && (
          <button
            type="button"
            onClick={() => setOpen((o) => !o)}
            className="flex items-center gap-2 px-3 py-2 h-10 text-sm font-semibold bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors shrink-0"
          >
        ...
        {hasActive && (
          <button
            ...
            onClick={onClearAll}
            className="flex items-center gap-1 px-3 py-2 h-10 text-xs font-semibold text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition-colors shrink-0"
          >
      ...
      {open && (
        <div className="w-full pt-3 mt-3 border-t border-slate-200 dark:border-slate-800/60 animate-in fade-in slide-in-from-top-2 duration-200">
