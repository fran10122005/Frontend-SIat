...
export default function PedirCitaModal({
  showModal,
  setShowModal,
  citaData,
  setCitaData,
        ...
        >
          <div className="space-y-1.5">
            ...
            <select
              ...
              onChange={(e) =>
                setCitaData({ ...citaData, esp_codi: e.target.value })
              }
              required
            >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
                <CalendarDays className="w-3.5 h-3.5 text-slate-400" /> Fecha
                Deseada
              </label>
              <input
                type="date"
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                value={citaData.hora}
                onChange={(e) =>
                  setCitaData({ ...citaData, hora: e.target.value })
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              value={citaData.tipo}
              onChange={(e) =>
                setCitaData({ ...citaData, tipo: e.target.value })
              }
            >
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
              <FileText className="w-3.5 h-3.5 text-slate-400" /> Motivo o Notas
              Adicionales
            </label>
            <textarea
              rows="3"
          ...
          <div className="pt-2 flex gap-3">
            ...
            <button
              type="submit"
              className="flex-1 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg shadow-sm shadow-blue-600/20 transition-all flex justify-center items-center gap-2"
            >
              Solicitar Cita
            </button>
          </div>
