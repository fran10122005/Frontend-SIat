...
function Register({ onNavigate }) {
  return (
    <div className="w-full min-h-full bg-white dark:bg-slate-900 flex flex-col px-6 sm:px-10 lg:px-16 pt-5 pb-8 sm:pt-7 sm:pb-10 transition-colors duration-200">
      <div className="w-full max-w-2xl mx-auto my-auto space-y-4 sm:space-y-5">
        {/* Header Section with Badge */}
        <div className="auth-rise auth-d0 flex flex-col items-center text-center md:items-start md:text-left space-y-3">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-500/10 dark:bg-blue-400/10 border border-blue-500/20 dark:border-blue-400/20 text-blue-600 dark:text-blue-400 text-xs font-semibold tracking-wide">
            <Sparkles className="w-3.5 h-3.5" />
            Acceso Institucional Seguro
          </div>
          <h1 className="text-xl sm:text-2xl font-extrabold text-brand-700 dark:text-blue-400 tracking-tight leading-tight">
            ¿Cómo ingresar a SIAT-TEA?
          </h1>
          <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm max-w-xl leading-snug">
            Para proteger la privacidad y el seguimiento clínico de los menores,
            las cuentas no son de creación pública. El acceso se gestiona de
            forma guiada por tu institución asociada.
          </p>
        </div>

        {/* Timeline of Steps */}
        <div className="relative pl-6 sm:pl-8 border-l-2 border-dashed border-blue-100 dark:border-slate-800 ml-4 sm:ml-5 space-y-3.5 sm:space-y-4 py-1 auth-rise auth-d1">
          {/* Step 1 */}
          <div className="relative">
            ...
            <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 p-3.5 sm:p-4 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 group hover:-translate-y-0.5">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-xxs sm:text-xs leading-relaxed">
                El centro terapéutico o fundación donde asistes debe estar
                registrado en nuestro sistema. Tu especialista te indicará si ya
                lo están.
              </p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 p-3.5 sm:p-4 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 group hover:-translate-y-0.5">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-xxs sm:text-xs leading-relaxed">
                El especialista o la fundación registrará tus datos y los del
                niño en el sistema para que puedas acceder a toda la información
                de sus terapias.
              </p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 p-3.5 sm:p-4 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 group hover:-translate-y-0.5">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-xxs sm:text-xs leading-relaxed">
                Recibirás un enlace en tu correo electrónico. Al abrirlo, podrás
                crear tu contraseña y empezar a usar el sistema de inmediato.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-blue-600 dark:from-indigo-950 dark:to-blue-950 p-4 sm:p-5 rounded-xl shadow-xl text-white relative overflow-hidden group auth-rise auth-d2">
          ...
          <div className="relative z-10 space-y-3">
            ...
            <p className="text-white/80 text-xxs sm:text-xs leading-relaxed max-w-lg">
              Si quieres afiliar a tu clínica o fundación al ecosistema SIAT,
              solicitar terapias de apoyo o recibir orientación especializada
              sobre el autismo, estamos listos para acompañarte.
            </p>
        ...
        <div className="auth-rise auth-d2 pt-2">
          <button
            type="button"
