...
export default function StudentRecord() {
  const { valMini, valMaxi, updateThresholds, showToast, userRole, selectedChildId, listaNinos, fetchNinos } = useGlobalContext()
  const [localMin, setLocalMin] = useState(valMini)
  const [localMax, setLocalMax] = useState(valMaxi)
  ...
  // Simulación de timestamp actual para fec_ingr
  const currentTimestamp = "23/05/2026 14:30"
