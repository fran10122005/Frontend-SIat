        ...
        <div className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm flex flex-col sm:flex-row gap-4 items-center justify-between">
          <div className="flex w-full sm:w-auto items-center gap-2">
            ...
            <input 
              ...
              className="px-3 py-2 bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-600 rounded-lg text-sm text-gray-700 dark:text-gray-300 outline-none focus:ring-2 focus:ring-[#007BFF]/20"
            />
          </div>
          ...
          <select
            ...
            className="w-full sm:w-auto px-4 py-2 bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-600 rounded-lg text-sm text-gray-700 dark:text-gray-300 outline-none focus:ring-2 focus:ring-[#007BFF]/20 cursor-pointer"
          >
              ...
              {sortedDates.map((date) => (
                <div key={date} className="relative">
                  ...
                  <div className="flex items-center justify-start mb-8 relative z-10 ml-1">
                    <span className="bg-white dark:bg-slate-800 text-[#003366] dark:text-blue-400 font-semibold text-sm px-4 py-1.5 rounded-full border border-gray-200 dark:border-slate-600 shadow-sm">
                      {formatDate(date)}
                    </span>
                  </div>
