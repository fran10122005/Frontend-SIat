        ...
        <form onSubmit={handleIncidentSubmit} className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                value={incidentData.duracion}
                onChange={(e) =>
                  setIncidentData({ ...incidentData, duracion: e.target.value })
                }
                className="w-full p-2.5 text-sm bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-lg outline-none focus:ring-2 focus:ring-rose-500 transition-all cursor-pointer"
              >
          ...
          <div>
            <label className="block text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-2">
              Detonante (A-B-C: Antecedente)
            </label>
            <select
              value={incidentData.detonante}
              onChange={(e) =>
                setIncidentData({ ...incidentData, detonante: e.target.value })
              }
              className="w-full p-2.5 text-sm bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-lg outline-none focus:ring-2 focus:ring-rose-500 transition-all cursor-pointer"
            >
          ...
          <div>
            <label className="block text-xs font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-2">
              Apoyo o Rutina Aplicada (Consecuencia)
            </label>
            <input
              type="text"
              value={incidentData.rutina}
              onChange={(e) =>
                setIncidentData({ ...incidentData, rutina: e.target.value })
              }
          ...
          <div>
            ...
            <textarea
              value={incidentData.observacion}
              onChange={(e) =>
                setIncidentData({
                  ...incidentData,
