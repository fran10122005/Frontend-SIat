  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      >
        ...
        <form
          onSubmit={handleUpdateInstitucion}
          ...
          {isEditing && (
            <div className="flex justify-end pt-2">
              <button
                disabled={loading}
                type="submit"
                data-tour="admin-cat-save"
                className="w-full md:w-auto px-8 bg-blue-600 hover:bg-blue-700 text-white py-2.5 rounded-lg text-sm font-semibold transition-colors disabled:opacity-50"
              >
                Guardar Cambios
              </button>
            </div>
