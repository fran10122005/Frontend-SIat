  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <form onSubmit={handleCreateEspecialista} className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 text-sm bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div>
                  ...
                  <select
                    disabled={userRole === "ADMIN_INSTITUCION"}
                    required
                    value={newEsp.ins_codi}
                    onChange={(e) =>
                      setNewEsp({ ...newEsp, ins_codi: e.target.value })
                    }
                    className="w-full px-4 py-2.5 text-sm bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 transition-colors cursor-pointer disabled:opacity-75 disabled:cursor-not-allowed"
                  >
                    <option value="" disabled>
                      Seleccione institución...
                    </option>
                    {catalogos.instituciones.map((ins) => (
                      <option key={ins.ins_codi} value={ins.ins_codi}>
                        {ins.ins_nomb}
                      </option>
                    ))}
                  </select>
                      ...
                      >
                        {editingEsp?.esp_codi === esp.esp_codi ? (
                          <td colSpan="4" className="py-3 px-4">
                            <form
                              onSubmit={handleUpdateEsp}
                              className="flex flex-col sm:flex-row gap-2 items-stretch sm:items-center w-full bg-slate-50 dark:bg-slate-900 p-2 rounded-lg"
                            >
                              <input
                                required
                                type="text"
                                ...
                                onChange={(e) =>
                                  setEditingEsp({
                                    ...editingEsp,
                                    esp_nomb: e.target.value,
                                  })
                                }
                                className="px-3 py-1.5 text-sm border border-slate-300 dark:border-slate-600 rounded bg-white dark:bg-slate-800 sm:w-1/4 outline-none focus:border-blue-500"
                                placeholder="Nombre"
                              />
                              <input
                                required
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  setEditingEsp({
                                    ...editingEsp,
                                    usu_crro: e.target.value,
                                  })
                                }
                                className="px-3 py-1.5 text-sm border border-slate-300 dark:border-slate-600 rounded bg-white dark:bg-slate-800 sm:w-1/3 outline-none focus:border-blue-500"
                                placeholder="Correo"
                              />
                              <div className="flex gap-2 sm:ml-auto">
                                ...
                                <button
                                  ...
                                  className="px-3 py-1.5 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-md text-sm font-semibold transition-colors"
                                >
                                  Cancelar
                                </button>
                              </div>
      ...
      {subView === "especialidades" && (
        ...
        >
          <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-6">
            Definición de Especialidad Médica
          </h2>
          <form
            onSubmit={handleCreateEspecialidad}
            className="space-y-5 mb-8 pb-8 border-b border-slate-200 dark:border-slate-700"
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 text-sm bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-lg outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 text-sm bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 h-24"
                placeholder="Evaluación diagnóstica y terapias conductuales especializadas en TEA..."
              />
            </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs font-semibold bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 px-3 py-1 rounded-full">
                {filteredEspecialidades.length} de{" "}
                {catalogos.especialidades.length} registradas
              </span>
            </div>
                          ...
                          <td colSpan="4" className="py-3 px-4">
                            ...
                            >
                              ...
                              <div className="flex gap-2 sm:ml-auto">
                                ...
                                <button
                                  type="button"
                                  onClick={() => setEditingEspCat(null)}
                                  className="px-3 py-1.5 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-md text-sm font-semibold"
                                >
                                  Cancelar
                                </button>
                              </div>
