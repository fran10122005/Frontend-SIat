            ...
            >
              {pagedNinos.map((nino) => (
                <div
                  key={nino.id_ninos}
                  data-tour="pm-card"
                  className="group flex flex-col bg-white dark:bg-slate-800 rounded-2xl p-6 border border-gray-200 dark:border-slate-700 shadow-sm hover:shadow-xl transition-all duration-300 relative overflow-hidden"
                >
