                  ...
                  <table className="w-full text-left text-sm">
                    ...
                    <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                      {dayNotes.map((note, i) => (
                        ...
                        >
                          <td className="px-4 py-4 font-mono text-slate-500 text-xs align-top whitespace-nowrap">
                            {note.time}
                          </td>
                          <td className="px-4 py-4 align-top">
                            <span
                              className={`px-2 py-1 rounded-md text-xs font-bold ${note.bpm && note.bpm > 100 ? "bg-rose-100 text-rose-600 dark:bg-rose-900/30 dark:text-rose-400" : "bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400"}`}
                            >
