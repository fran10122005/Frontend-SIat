...
export default function Routines() {
  ...
  const handleCreateRoutine = async (e) => {
    ...
    if (formData.peiGoalDesc.trim()) {
      await crearPeiGoal(
        selectedChildId,
        formData.peiGoalDesc,
        formData.peiGoalTrials,
      );
    }
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="flex justify-between items-end mb-8">
                  ...
                  <button
                    ...
                    data-tour="rt-create"
                    className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-sm flex items-center gap-2 text-sm transition-transform hover:scale-105"
                  >
                  ...
                  {routines.map((routine) => (
                    ...
                    >
                      <div>
                        ...
                        <h3 className="text-lg font-black text-slate-800 dark:text-white mb-3 leading-tight">
                          {routine.title}
                        </h3>
                  ...
                  <div className="px-8 py-6 bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center shrink-0">
                    ...
                    {!isFinishing && (
                      <button
                        ...
                        onClick={endSession}
                        className="px-6 py-3 bg-rose-500 hover:bg-rose-600 text-white font-bold rounded-xl shadow-sm flex items-center gap-2 transition-colors"
                      >
                  ...
                  <div className="flex-1 p-8 md:p-12 flex flex-col md:flex-row gap-12 items-center justify-center">
                    ...
                    >
                      <div className="w-56 h-56 rounded-full border-[14px] border-slate-100 dark:border-slate-800 flex items-center justify-center relative shadow-inner">
                        <div
                          className={`absolute inset-0 rounded-full border-[14px] border-transparent ${!isFinishing ? "border-t-blue-500 animate-spin" : ""}`}
                      ...
                      <p className="text-sm font-bold text-slate-400 mt-6 tracking-widest uppercase">
                        Tiempo Registrado
                      </p>
                    </div>
                    ...
                    <div
                      data-tour="rt-live-steps"
                      className="flex-1 w-full bg-slate-50 dark:bg-slate-800/30 p-8 rounded-[1.5rem] border border-slate-100 dark:border-slate-700/50 shadow-inner"
                    >
                      ...
                      <div className="max-w-md w-full flex flex-col items-center text-center my-auto pb-8">
                        ...
                        <div className="w-full space-y-8 text-left">
                          <div className="bg-slate-50 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-100 dark:border-slate-800">
                            <label
                              ...
                              className="text-xs font-black uppercase tracking-widest text-slate-500 mb-4 block text-center"
                            >
                            ...
                            <div className="flex justify-center gap-2">
                              {[1, 2, 3, 4, 5].map((val) => (
                                ...
                                >
                                  <Star
                                    className={`w-10 h-10 ${val <= cooperation ? "fill-amber-400 text-amber-400 drop-shadow-md" : "text-slate-200 dark:text-slate-700 fill-transparent"}`}
                                  />
                                </button>
                              ))}
                            </div>
                        ...
                        <div className="flex gap-4 w-full mt-10">
                          <button
                            ...
                            className="flex-1 py-4 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 font-bold rounded-2xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
                          >
                            Volver
                          </button>
                          <button
                            ...
                            className="flex-1 py-4 bg-blue-600 text-white font-bold rounded-2xl hover:bg-blue-700 shadow-lg shadow-blue-500/30 transition-all hover:-translate-y-1"
                          >
                            Guardar Bitácora
                          </button>
                        </div>
