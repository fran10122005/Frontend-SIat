          ...
          <div className="max-w-[1400px] w-full mx-auto p-6 md:p-8 lg:p-10 flex flex-col gap-8">
            <header className="mb-8">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 transition-colors">
                Administración de datos maestros y parámetros de sensibilidad
                del paciente.
              </p>
            </header>
                ...
                <div className="p-6 md:p-8">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
                    <div className="space-y-6">
                      <h3
                        data-tour="sr-identity"
                        className="text-sm font-semibold text-brand-700 dark:text-blue-300 uppercase tracking-wider border-b border-gray-100 dark:border-slate-700 pb-2 transition-colors"
                      >
                        Datos de Identidad
                      </h3>
                      ...
                      <div className="space-y-1">
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                          ...
                          <span className="text-xs text-gray-400 dark:text-gray-500 font-normal ml-1"></span>
                        </label>
                        <input
                          type="text"
                          name="id_ninos"
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-4" data-tour="sr-gender">
                          <label
                            className={`flex items-center p-3 border border-gray-200 dark:border-slate-700 rounded-lg transition-colors flex-1 ${!isEditing ? "bg-gray-50 cursor-not-allowed dark:bg-slate-800/50" : "cursor-pointer hover:bg-gray-50 dark:hover:bg-slate-700/50"}`}
                          >
                            <input
                              type="radio"
                              name="gen_nino"
                      ...
                      <div className="space-y-1">
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                          Vincular Perfil de Sensibilidad{" "}
                          <span className="text-xs text-gray-400 dark:text-gray-500 font-normal ml-1"></span>
                        </label>
                        <div className="relative">
                          <select
                          ...
                          >
                            <option value="" disabled>
                              Seleccionar perfil de sensibilidad...
                            </option>
                    ...
                    {!isEditing ? (
                      <button
                        ...
                        onClick={() => {
                          if (!selectedChildId) {
                            showToast(
                              "⚠️ Debes seleccionar un paciente en el menú superior primero.",
                            );
                            return;
                          }
                          setIsEditing(true);
            ...
            <div
              data-tour="sr-links"
              className="flex flex-col sm:flex-row gap-4 sm:gap-8 mt-2 pl-2"
            >
              <button
