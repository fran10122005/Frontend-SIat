...
export default function HistoryProgress() {
  ...
  useEffect(() => { setPage(0) }, [dateRange, searchNotes, filterEfectividad])
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-wrap gap-3 items-center">
                <div className="relative w-full sm:flex-1 sm:min-w-[200px]">
                  ...
                  <input type="text" placeholder="Buscar en notas médicas..." value={searchNotes} onChange={e => setSearchNotes(e.target.value)} className="w-full pl-4 pr-9 py-2 text-sm bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg outline-none focus:ring-2 focus:ring-blue-500" />
                </div>
